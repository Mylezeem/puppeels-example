...
#
protocol=http
webservers=('web001.puppeels.mylezeem.com' 'web002.puppeels.mylezeem.com')
webpages=['/page1','/page2','/page42','anotherpager','/doesntevenexist','/']

declare -a webservers=('web001.puppeels.mylezeem.com' 'web002.puppeels.mylezeem.com');
declare -a webpages=('/page1' '/page2' '/page42' '/anotherpage' '/doesntevenexist' '/' '/' '/');

echo ${webservers[0]}

for i in {1..1000};do
  random_webserver=$(($RANDOM%2+0))
